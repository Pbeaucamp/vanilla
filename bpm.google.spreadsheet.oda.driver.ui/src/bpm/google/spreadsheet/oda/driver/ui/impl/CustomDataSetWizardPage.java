...
package bpm.google.spreadsheet.oda.driver.ui.impl;
...
public class CustomDataSetWizardPage extends DataSetWizardPage
{
    ...
    private Control createPageControl( Composite parent )
    {
        ...
        fieldLabel.setText( "&Query Text:" ); //$NON-NLS-1$
	...
	private void savePage( DataSetDesign dataSetDesign )
	{
        ...
        try
        {
             ...
             */
            IDriver customDriver = new bpm.google.spreadsheet.oda.driver.runtime.impl.Driver();
