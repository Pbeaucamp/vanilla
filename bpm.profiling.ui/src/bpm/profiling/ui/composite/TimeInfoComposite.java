...
import bpm.profiling.ui.composite.utils.CronTimer;
...
public class TimeInfoComposite extends Composite {
	...
	// Screen labels. 
	public static final String Cycle   = "Cycle/frequency";
	...
	public static final String On_day  = "On day number";

	public static final String Start_time = "Start time";
	public static final String Start_on   = "Start job on";
	...
	public static final String[] Offset      = {"The first", "The last"};
	

	// Errors messages
	public static final String Error_reading_hourly_cycle =	"Error reading hourly cycle";
	public static final String Error_cron_syntax = "Cron expression is incorrect.";
...
//	}
	...
	public void createMessageGroup(Composite c) {
		Group grpMessage = new Group(c, SWT.NONE);
		grpMessage.setLayout(new GridLayout(1, false));
		grpMessage.setLayoutData(new GridData(GridData.FILL_HORIZONTAL | GridData.FILL_VERTICAL));
		grpMessage.setText(Message);

		message = new Text(grpMessage, SWT.MULTI);
		message.setLayoutData(new GridData(GridData.FILL_HORIZONTAL | GridData.FILL_VERTICAL));
    ...
    protected void updateTimer() {
    	...
    	if(btnOnce.getSelection()){
        	...
        	try{
    			...
    			message.setText(Error_cron_syntax);
        	}
    	}
		...
		try {
			...
			startTimeStr += f.format(startDate.getMonth()) +".";
			startTimeStr += f.format(startDate.getDay());
			startTimeStr += " at ";
			startTimeStr += f.format(startTime.getHours()) + ":";
			startTimeStr += f.format(startTime.getMinutes()) + ":";
