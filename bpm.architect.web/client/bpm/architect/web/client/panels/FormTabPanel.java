...
public class FormTabPanel extends Composite implements TabManager {
	
	private static final double MIN_DEFAULT_PERCENTAGE = 0.5;

	private static FormTabPanelUiBinder uiBinder = GWT.create(FormTabPanelUiBinder.class);

	interface FormTabPanelUiBinder extends UiBinder<Widget, FormTabPanel> {}
	...
	public FormTabPanel(InfoUser infoUser) {
		initWidget(uiBinder.createAndBindUi(this));
		this.infoUser = infoUser;
		
		FormPanel panel = new FormPanel(infoUser, this);
		changeTab(panel, true);
	}
