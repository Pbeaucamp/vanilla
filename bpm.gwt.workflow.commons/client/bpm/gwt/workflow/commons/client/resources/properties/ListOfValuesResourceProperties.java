...
public class ListOfValuesResourceProperties extends PropertiesPanel<Resource> implements NameChanger {
	...
	public ListOfValuesResourceProperties(NameChecker dialog, IResourceManager resourceManager, ListOfValues myLov) {
		super(resourceManager, LabelsCommon.lblCnst.Name(), WidgetWidth.SMALL_PX, myLov != null ? myLov.getId() : 0, myLov != null ? myLov.getName() : LabelsCommon.lblCnst.ListOfValues(), false, true);
		this.lov = myLov != null ? myLov : new ListOfValues(LabelsCommon.lblCnst.ListOfValues());
	...
	public boolean isValid() {
		...
		if (values == null || values.isEmpty()) {
			isValid = false;
			valuesPanel.setTxtError(LabelsCommon.lblCnst.AtLeastOneValueNeeded());
		}
		else {
