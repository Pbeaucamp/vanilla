...
public abstract class AbstractRemoteAuthentifier {
	...
	protected void writeAuthentication(HttpURLConnection sock) {
		/*
		 * if (sessionId != null){ sock.setRequestProperty(
		 * IVdmConstant.HTTP_HEADER_VDM_SESSION_ID, sessionId ); }
		 */
		if (sessionId == null) {
...
//		}
	...
	protected void extractSessionId(HttpURLConnection sock) {
		if (sessionId == null) {
			sessionId = sock.getHeaderField(IAklaflowConstant.HTTP_HEADER_AKLAFLOW_SESSION_ID);
		}
	}
