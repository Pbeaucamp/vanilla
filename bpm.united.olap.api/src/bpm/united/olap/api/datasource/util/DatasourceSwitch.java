 ...
 * $Id$
 */
package bpm.united.olap.api.datasource.util;
...
public class DatasourceSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DatasourcePackage.DATASOURCE: {
				Datasource datasource = (Datasource)theEObject;
				T result = caseDatasource(datasource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DatasourcePackage.DATA_OBJECT: {
				DataObject dataObject = (DataObject)theEObject;
				T result = caseDataObject(dataObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DatasourcePackage.DATA_OBJECT_ITEM: {
				DataObjectItem dataObjectItem = (DataObjectItem)theEObject;
				T result = caseDataObjectItem(dataObjectItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DatasourcePackage.CONNECTION: {
				Connection connection = (Connection)theEObject;
				T result = caseConnection(connection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DatasourcePackage.RELATION: {
				Relation relation = (Relation)theEObject;
				T result = caseRelation(relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DatasourcePackage.OPERATOR: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Data Object Item</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Data Object Item</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDataObjectItem(DataObjectItem object) {
		return null;
	}
