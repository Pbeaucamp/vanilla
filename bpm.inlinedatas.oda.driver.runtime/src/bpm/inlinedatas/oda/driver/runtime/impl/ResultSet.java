...
public class ResultSet implements IResultSet
{
    ...
    private ArrayList<PropertieColumn> listDataset;
	
	public ResultSet(ArrayList<PropertieColumn> pListDataSet) {
		listDataset = new ArrayList<PropertieColumn>();
		listDataset.addAll(pListDataSet);
	...
	public IResultSetMetaData getMetaData() throws OdaException
	{
         ...
         */
		return new ResultSetMetaData(listDataset);
	}
	...
	{
		m_maxRows = listDataset.get(0).getListPropertieData().size();
	}
	...
	public boolean next() throws OdaException
	{
        ...
        if(listDataset.get(0).getListPropertieData().isEmpty()){
        	return false;
        }
	...
	{
		Object currentCell = listDataset.get(index-1).getListPropertieData().get(m_currentRowId-1).getPropertieDataValue();
	...
	public int getInt( int index ) throws OdaException
	{
		...
		try{
			cellToInt = Integer.parseInt(currentCell.toString());
			return cellToInt;
	...
	{
		Object currentCell = listDataset.get(index-1).getListPropertieData().get(m_currentRowId-1).getPropertieDataValue();
		double cellToDouble = 0;
		
		try{
			cellToDouble = Double.parseDouble(currentCell.toString());
			return cellToDouble;
    ...
    public boolean getBoolean( int index ) throws OdaException
    {
    	...
    	Object currentCell = listDataset.get(index-1).getListPropertieData().get(m_currentRowId-1).getPropertieDataValue();
		boolean cellToBoolean = false;
    	
    	try{
    		cellToBoolean = Boolean.valueOf(currentCell.toString());
            return cellToBoolean;
    ...
    public int findColumn( String columnName ) throws OdaException
    {
    	...
    	int i = 1;
    	for(PropertieColumn col : this.listDataset) {
    		if(col.getPropertieColName().equals(columnName)) {
    			return i;
    		}
    		i++;
    	}
