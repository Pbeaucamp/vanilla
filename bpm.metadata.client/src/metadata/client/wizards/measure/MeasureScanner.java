...
public class MeasureScanner extends RuleBasedScanner {
	private static Color COLOR_KEYWORD = new Color(Display.getDefault(), 155, 0, 155);
	private static Color COLOR_OTHER = new Color(Display.getDefault(), 0, 0, 0);
	private static Color COLOR_MEASURE = new Color(Display.getDefault(), 0, 200, 0);
	private static Color COLOR_DIMENSION = new Color(Display.getDefault(), 0, 0, 190);
	private static Color COLOR_LITERAL = new Color(Display.getDefault(), 255, 139, 23);

	private List<String> keyWords = new ArrayList<String>();

	public MeasureScanner(List<IDataStreamElement> measuresCandidates, List<FmdtDimension> dimensions) {
		...
		for (IDataStreamElement e : measuresCandidates) {
		...
		for (FmdtDimension e : dimensions) {
