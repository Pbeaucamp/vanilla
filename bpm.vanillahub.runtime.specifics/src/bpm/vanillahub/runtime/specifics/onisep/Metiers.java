 ...
 *       &lt;sequence>
 *         &lt;element name="metier" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
...
@XmlRootElement(name = "metiers")
public class Metiers implements IExportCSV {

    protected List<Metier> metier;
     ...
     * This is why there is not a <CODE>set</CODE> method for the metier property.
     * 
     * <p>
	...
	public void buildCSV(String parentId, HashMap<String, List<List<Object>>> items) {
		...
		if (metier != null) {
			for (Metier metier : metier)  {
				metier.buildCSV(null, items);
			}
		}
	}
