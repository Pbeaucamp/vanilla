...
public class CentresInteret implements IExportCSV {

    @XmlElement(name = "centre_interet")
    protected List<CentreInteret> centreInteret;

    /**
     * Gets the value of the centreInteret property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the centreInteret property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCentreInteret().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<CentreInteret> getCentreInteret() {
        if (centreInteret == null) {
            centreInteret = new ArrayList<CentreInteret>();
        }
	...
	public void buildCSV(String parentId, HashMap<String, List<List<Object>>> items) {
		...
		if (centreInteret != null) {
			for (CentreInteret item : centreInteret)  {
