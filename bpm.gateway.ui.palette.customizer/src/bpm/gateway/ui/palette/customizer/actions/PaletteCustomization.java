package bpm.gateway.ui.palette.customizer.actions;
 ...
 */
public class PaletteCustomization implements IWorkbenchWindowActionDelegate {
	private IWorkbenchWindow window;
	/**
	 * The constructor.
	 */
	public PaletteCustomization() {
	}
