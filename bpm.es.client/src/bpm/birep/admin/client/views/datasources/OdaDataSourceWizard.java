...
//	private DataSourceWizardPage startPage;
	private DatasourceDefinitionPage definitionPage;
	private DataSourceTypePage typePage;
	private String currentExtensionId;
	private DataSource odaInput;

	public OdaDataSourceWizard(DataSource odaInput) throws OdaException {
		super();
	...
	public void addPages() {
		definitionPage = new DatasourceDefinitionPage("Datasource Definition", odaInput); //$NON-NLS-1$
		definitionPage.setTitle(Messages.OdaDataSourceWizard_1);
		definitionPage.setDescription(Messages.OdaDataSourceWizard_2);

		addPage(definitionPage);
		
		typePage = new DataSourceTypePage("DataSource Type Page", odaInput); //$NON-NLS-1$
		typePage.setTitle(Messages.OdaDataSourceWizard_3);
		typePage.setDescription(Messages.OdaDataSourceWizard_4);
