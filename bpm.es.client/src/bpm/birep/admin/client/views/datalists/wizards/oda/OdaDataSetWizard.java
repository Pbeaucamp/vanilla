...
public class OdaDataSetWizard extends DataSetWizard {
	 ...
	 * NewDataSourceWizardBase#performFinish()
	 */
	@Override
	public boolean performFinish() {
		DataSetWizardPage p = (DataSetWizardPage) typePage.getDesignPage();
...
//			dd = ((DataSetWizard) typePage.getNextPage().getWizard()).getResponseSession().getResponseDataSetDesign();
	...
	public void addPages() {
		typePage = new DataSetTypePage(Messages.Client_Views_DataLists_OdaDataSetWizard_1, odaInput);
