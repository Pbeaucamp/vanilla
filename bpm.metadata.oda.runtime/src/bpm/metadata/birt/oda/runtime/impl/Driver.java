...
{
    static String ODA_DATA_SOURCE_ID = "bpm.metadata.birt.oda.runtime";  //$NON-NLS-1$
    static String ODA_DATA_SOURCE_OLAP_ID = "bpm.metadata.birt.oda.runtime.olap";
...
//		}
		...
		if(dataSourceType != null && dataSourceType.equals(ODA_DATA_SOURCE_OLAP_ID)) {
			return new UnitedOlapConnection();
