...
!define APP_NAME "VanillaServer-Tomcat6"
!define APP_Version "4.0"
Name ${APP_NAME}

!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\Vanilla\Serie4\${APP_NAME}"
...
#Configuratioon de la finish page avec creation ou pas d'un "desktop shortcut"
	...
	!define MUI_FINISHPAGE_LINK "Visit the VanillaServer-Tomcat6 website for the latest updates."
...
#creation des raccourcis
	...
	CreateShortCut "$SMPROGRAMS\$STARTMENU_FOLDER\start-vanilla.lnk" "$INSTDIR\start-vanilla.cmd"
	CreateShortCut "$SMPROGRAMS\$STARTMENU_FOLDER\stop-vanilla.lnk" "$INSTDIR\stop-vanilla.cmd"
...
Section Documentation
		...
		File "License\Vanilla_Public_license1.1.txt"
...
Function CreateDeskLink
	...
	CreateShortCut "$DESKTOP\start-vanilla.lnk" "$INSTDIR\start-vanilla.cmd" ""
	CreateShortCut "$DESKTOP\stop-vanilla.lnk" "$INSTDIR\stop-vanilla.cmd" ""
