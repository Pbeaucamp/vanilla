...
!define APP_NAME "VanillaServerAdministrator"
!define APP_Version "4.0"
Name ${APP_NAME}

!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\Vanilla\Serie4\AdminEnterprise\${APP_NAME}"
!define PRODUCT_UNINST_ROOT_KEY "HKLM"
!define PRODUCT_STARTMENU_REGVAL "BPM:Start Menu Folder"

!define PRODUCT_INSTALL_DIR "$PROGRAMFILES\Vanilla\Serie4\AdminEnterprise\${APP_NAME}"
...
#Cle de registre
InstallDirRegKey HKCU "Software\Vanilla\Serie4\AdminEnterprise\${APP_NAME}" ""
...
!insertmacro MUI_PAGE_LICENSE "VanillaServerAdministrator\license\License.txt"
...
#Configuratioon de la finish page avec creation ou pas d'un "desktop shortcut"
	...
	!define MUI_FINISHPAGE_LINK "Visit the VanillaServerAdministrator website for the latest updates."
...
#Copie des fichier du RCP
  SetOutPath "$INSTDIR"
  File /r "VanillaServerAdministrator\*.*"
...
Section Create_Start_Menu_Shortcut
 ...
 #Inscription a la base de registre du desinstalleur
  WriteRegStr HKCU "Software\Vanilla\Serie4\AdminEnterprise\${APP_NAME}" "" $INSTDIR
...
Section Documentation
		...
		#File "VanillaServerAdministrator\Readme.txt"
		File "VanillaServerAdministrator\license\License.txt"
...
Section Uninstall
 ...
 startMenuDeleteLoop:
  ...
  DeleteRegKey /ifempty HKCU "Software\Vanilla\Serie4\AdminEnterprise\${APP_NAME}"
