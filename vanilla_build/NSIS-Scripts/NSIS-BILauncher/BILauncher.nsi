...
!define APP_NAME "BILauncher"
!define APP_Version "4.0"
Name ${APP_NAME}

!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\Vanilla\Serie4\User\${APP_NAME}"
!define PRODUCT_UNINST_ROOT_KEY "HKLM"
!define PRODUCT_STARTMENU_REGVAL "BPM:Start Menu Folder"

!define PRODUCT_INSTALL_DIR "$PROGRAMFILES\Vanilla\Serie4\User\${APP_NAME}"
...
#Cle de registre
InstallDirRegKey HKCU "Software\Vanilla\Serie4\User\${APP_NAME}" ""
...
!insertmacro MUI_PAGE_LICENSE "BILauncher\license\License.txt"
...
#Configuratioon de la finish page avec creation ou pas d'un "desktop shortcut"
	...
	!define MUI_FINISHPAGE_LINK "Visit the BILauncher website for the latest updates."
...
Section Create_Start_Menu_Shortcut
 ...
 #Inscription a la base de registre du desinstalleur
  WriteRegStr HKCU "Software\Vanilla\Serie4\User\${APP_NAME}" "" $INSTDIR
...
Section Documentation
		...
		#File "BILauncher\Readme.txt"
		File "BILauncher\license\License.txt"
...
Section Uninstall
 ...
 startMenuDeleteLoop:
  ...
  DeleteRegKey /ifempty HKCU "Software\Vanilla\Serie4\User\${APP_NAME}"
