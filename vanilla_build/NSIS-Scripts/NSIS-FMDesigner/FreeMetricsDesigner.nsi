...
!define APP_NAME "FmDesigner"
!define APP_Version "V4.0"
Name ${APP_NAME}

!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\Vanilla\Serie4\FM\${APP_NAME}"
!define PRODUCT_UNINST_ROOT_KEY "HKLM"
!define PRODUCT_STARTMENU_REGVAL "BPM:Start Menu Folder"

!define PRODUCT_INSTALL_DIR "$PROGRAMFILES\Vanilla\Serie4\FM\${APP_NAME}"
...
#Cle de registre
InstallDirRegKey HKCU "Software\Vanilla\Serie4\FM\${APP_NAME}" ""
...
!insertmacro MUI_PAGE_LICENSE "FmDesigner\license\License.txt"
...
#Configuratioon de la finish page avec creation ou pas d'un "desktop shortcut"
	...
	!define MUI_FINISHPAGE_LINK "Visit the FreeMetricsDesigner website for the latest updates."
...
Section Documentation
		...
		#File "FreeMetricsDesigner\Readme.txt"
		File "FmDesigner\license\License.txt"
...
Section Uninstall
 ...
 startMenuDeleteLoop:
  ...
  DeleteRegKey /ifempty HKCU "Software\Vanilla\Serie4\FM\${APP_NAME}"
...
Function CreateDeskLink
	...
	CreateShortCut "$DESKTOP\${APP_NAME}.lnk" "$INSTDIR\FMDesigner.exe" ""
