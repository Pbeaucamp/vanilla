...
!define APP_NAME "EnterpriseServices"
!define APP_Version "4.0"
Name ${APP_NAME}

!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\Vanilla\Serie4\Administrator\${APP_NAME}"
!define PRODUCT_UNINST_ROOT_KEY "HKLM"
!define PRODUCT_STARTMENU_REGVAL "BPM:Start Menu Folder"

!define PRODUCT_INSTALL_DIR "$PROGRAMFILES\Vanilla\Serie4\Administrator\${APP_NAME}"
...
#Cle de registre
InstallDirRegKey HKCU "Software\Vanilla\Serie4\Administrator\${APP_NAME}" ""
...
!insertmacro MUI_PAGE_LICENSE "EnterpriseServices\licence\Licence.txt"
...
#Configuratioon de la finish page avec creation ou pas d'un "desktop shortcut"
	...
	!define MUI_FINISHPAGE_LINK "Visit the Enterprise Services website for the latest updates."
...
Section Create_Start_Menu_Shortcut
 ...
 #Inscription a la base de registre du desinstalleur
  WriteRegStr HKCU "Software\Vanilla\Serie4\Administrator\${APP_NAME}" "" $INSTDIR
...
Section Documentation
		...
		#File "EntrepriseServices\Readme.txt"
		File "EnterpriseServices\licence\Licence.txt"
...
Section Uninstall
 ...
 startMenuDeleteLoop:
  ...
  DeleteRegKey /ifempty HKCU "Software\Vanilla\Serie4\Administrator\${APP_NAME}"
