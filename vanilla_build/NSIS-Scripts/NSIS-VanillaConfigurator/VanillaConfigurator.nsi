...
!define APP_NAME "VanillaConfigurator"
!define APP_Version "3.4"
Name ${APP_NAME}

!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\Vanilla\Serie3\Administrator\${APP_NAME}"
!define PRODUCT_UNINST_ROOT_KEY "HKLM"
!define PRODUCT_STARTMENU_REGVAL "BPM:Start Menu Folder"

!define PRODUCT_INSTALL_DIR "$PROGRAMFILES\Vanilla\Serie3\Administrator\${APP_NAME}"
...
#Cle de registre
InstallDirRegKey HKCU "Software\Vanilla\Serie3\Administrator\${APP_NAME}" ""
...
!insertmacro MUI_PAGE_LICENSE "VanillaConfigurator\license\License.txt"
...
#Configuratioon de la finish page avec creation ou pas d'un "desktop shortcut"
	...
	!define MUI_FINISHPAGE_LINK "Visit the VanillaConfigurator website for the latest updates."
...
Section Create_Start_Menu_Shortcut
 ...
 #Inscription a la base de registre du desinstalleur
  WriteRegStr HKCU "Software\Vanilla\Serie3\Administrator\${APP_NAME}" "" $INSTDIR
...
Section Documentation
		...
		#File "VanillaConfigurator\Readme.txt"
		File "VanillaConfigurator\license\License.txt"
...
Section Uninstall
 ...
 startMenuDeleteLoop:
  ...
  DeleteRegKey /ifempty HKCU "Software\Vanilla\Serie3\Administrator\${APP_NAME}"
