...
!insertmacro MUI_PAGE_LICENSE "FmAdmin\license\License.txt"
...
#Configuratioon de la finish page avec creation ou pas d'un "desktop shortcut"
	...
	!define MUI_FINISHPAGE_LINK "Visit the FmAdmin website for the latest updates."
...
Section Create_Start_Menu_Shortcut
 ...
 #Inscription a la base de registre du desinstalleur
  WriteRegStr HKCU "Software\Vanilla\Serie4\FM\${APP_NAME}" "" $INSTDIR
...
Section Documentation
		...
		#File "FreeMetricsAdministrator\Readme.txt"
		File "FmAdmin\license\License.txt"
