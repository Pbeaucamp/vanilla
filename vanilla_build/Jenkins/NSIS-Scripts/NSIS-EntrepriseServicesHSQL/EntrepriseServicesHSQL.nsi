...
!define APP_NAME "EntrepriseServicesHSQL"
!define APP_Version "2.0-GA"
Name ${APP_NAME}

!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\Vanilla\Serie2.0\Administrator\${APP_NAME}"
!define PRODUCT_UNINST_ROOT_KEY "HKLM"
!define PRODUCT_STARTMENU_REGVAL "BPM:Start Menu Folder"

!define PRODUCT_INSTALL_DIR "$PROGRAMFILES\Vanilla\Serie2.0\Administrator\${APP_NAME}"
...
#Cle de registre
InstallDirRegKey HKCU "Software\Vanilla\Serie2.0\Administrator\${APP_NAME}" ""
...
!insertmacro MUI_PAGE_LICENSE "EntrepriseServicesHSQL\License.txt"
...
#Configuratioon de la finish page avec creation ou pas d'un "desktop shortcut"
	...
	!define MUI_FINISHPAGE_LINK "Visit the Entreprise Services for HSQL website for the latest updates."
...
Section Create_Start_Menu_Shortcut
 ...
 #Inscription a la base de registre du desinstalleur
  WriteRegStr HKCU "Software\Vanilla\Serie2.0\Administrator\${APP_NAME}" "" $INSTDIR
...
Section Documentation
		...
		File "EntrepriseServicesHSQL\Readme.txt"
		File "EntrepriseServicesHSQL\License.txt"
...
Section Uninstall
 ...
 startMenuDeleteLoop:
  ...
  DeleteRegKey /ifempty HKCU "Software\Vanilla\Serie2.0\Administrator\${APP_NAME}"
