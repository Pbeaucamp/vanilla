...
public class DialogGroupPickers extends Dialog{
	...
	protected Control createDialogArea(Composite parent) {
		...
		l.setText(Messages.DialogGroupPickers_0);
	...
	protected void initializeBounds() {
		...
		getShell().setText(Messages.DialogGroupPickers_1);
		
		IVanillaAPI api = Activator.getDefault().getVanillaApi();
		List<String> l = new ArrayList<String>();
		try {
			for(Group g : api.getVanillaSecurityManager().getGroups()){
				l.add(g.getName());
			}
		} catch (Exception e) {
