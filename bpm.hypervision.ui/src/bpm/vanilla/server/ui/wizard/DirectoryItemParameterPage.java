...
public class DirectoryItemParameterPage extends WizardPage{
	...
	public void createControl(Composite parent) {
		...
		paramName.getColumn().setText(Messages.DirectoryItemParameterPage_0);
		...
		paramValue.getColumn().setText(Messages.DirectoryItemParameterPage_1);
