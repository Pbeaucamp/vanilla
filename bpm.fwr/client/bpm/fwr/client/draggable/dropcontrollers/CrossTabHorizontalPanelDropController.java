...
public class CrossTabHorizontalPanelDropController extends AbstractInsertPanelDropController {
	...
	*/
	...
	public CrossTabHorizontalPanelDropController(CrossTabCell dropTarget, CrossTabCell crosstabCell) {
		super(dropTarget);
