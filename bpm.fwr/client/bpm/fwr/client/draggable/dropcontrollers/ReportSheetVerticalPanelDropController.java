...
public class ReportSheetVerticalPanelDropController extends AbstractPositioningDropController{
	/**
	* Our drop target.
	*/
	 ...
	 */
	public ReportSheetVerticalPanelDropController(ReportSheet reportSheet, VerticalPanel dropTarget) {
	...
	public void onDrop(DragContext context) {
	    ...
	    for (Widget widget : context.selectedWidgets) {
	    	...
	    	reportSheet.switchWidget(widget, dropIndex);
