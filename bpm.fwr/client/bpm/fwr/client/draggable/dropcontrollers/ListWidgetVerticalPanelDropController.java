...
public class ListWidgetVerticalPanelDropController extends AbstractPositioningDropController{
	/**
	* Our drop target.
	*/
	 ...
	 */
	public ListWidgetVerticalPanelDropController(ListCell cell, VerticalPanel dropTarget) {
