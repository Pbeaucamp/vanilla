package bpm.mdm.ui.splashHandlers;
...
public class InteractiveSplashHandler extends AbstractSplashHandler {
	...
	private void createUICompositeLogin() {
		...
		txtVanillaUrl.setText("http://localhost:7171/VanillaRuntime");

		GridData dataLoad = new GridData(SWT.NONE, SWT.NONE, false, false);
	...
	private void handleButtonOKWidgetSelected() {
		try {
			...
			IVanillaContext vanillaCtx = new BaseVanillaContext(txtVanillaUrl.getText(), txtLogin.getText(), txtPassword.getText());
			...
			e.printStackTrace();
			MessageDialog.openError(getSplash().getShell(), "Problem", e.getMessage());
		}
	...
	private void initRepositories() {
		try {
			...
			MessageDialog.openError(getSplash().getShell(), "Error while loading repositories", e.getMessage());
		}
		updateConnectButton();
	}
