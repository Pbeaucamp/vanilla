...
public class ApplicationWorkbenchWindowAdvisor extends WorkbenchWindowAdvisor {
    ...
    public void preWindowOpen() {
        ...
        configurer.setTitle("Master Data Management");
    ...
    public void postWindowOpen() {
		...
		SupplierManagementView view = (SupplierManagementView) page.findView(SupplierManagementView.ID);
		view.init();
//		DialogRepository dial = new DialogRepository(Activator.getDefault().getWorkbench().getActiveWorkbenchWindow().getShell());
