...
public class ResultSet implements IResultSet
{
	...
	{
		m_maxRows = tableSelect.getTableCountRow();
	}
	...
	{
		 return tableSelect.getListRows().get(m_currentRowId-1).getListCells().get(index-1);
	}
	...
	{
		Object obj = tableSelect.getListRows().get(m_currentRowId-1).getListCells().get(index-1);
