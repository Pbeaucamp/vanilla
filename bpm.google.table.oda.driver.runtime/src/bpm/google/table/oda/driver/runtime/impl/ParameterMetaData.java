...
public class ParameterMetaData implements IParameterMetaData 
{
	...
	private ArrayList<OdaGoogleTableParameter> listParam;

	public ParameterMetaData(ArrayList<OdaGoogleTableParameter> listParameter) {
		
		listParam = new ArrayList<OdaGoogleTableParameter>();
		listParam.addAll(listParameter);
    ...
    {
    	try{
    		return listParam.get(param-1).getParamName();
	    		
    	}catch(IndexOutOfBoundsException e){
    		
    		throw new OdaException("Only " + listParam.size() + " parameters in the query, cannot get the parameter " + param);
    	}
    }
	...
	public int getParameterType( int param ) throws OdaException 
	{
		...
		Class typeCol = listParam.get(param-1).getParamClass();
