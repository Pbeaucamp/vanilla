...
public class ExportModel {
	...
	private final static String CONF_FILE_PATH = "resources/FlexPropertys.xml"; //$NON-NLS-1$
	private final static String APP_ROOT_PATH ="resources/bin-release/"; //$NON-NLS-1$
	// TAGS
	private final static String TAG_APPNAME="swf_file"; //$NON-NLS-1$
	//private final static String TAG_APPROOTPATH = "root_path";
	private final static String TAG_DATAPATH="data_path"; //$NON-NLS-1$
	private final static String TAG_DATANAME="data_name"; //$NON-NLS-1$
	private final static String TAG_HTMLFILE="html_file"; //$NON-NLS-1$
	// Data
