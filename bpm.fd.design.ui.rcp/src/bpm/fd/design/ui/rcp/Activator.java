...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "bpm.fd.design.ui.rcp"; //$NON-NLS-1$
	...
	public FdSourceProvider getSessionSourceProvider() {
		ISourceProviderService service = (ISourceProviderService) getWorkbench()
		.getActiveWorkbenchWindow().getService(
				ISourceProviderService.class);
		return (FdSourceProvider) service
		.getSourceProvider(FdSourceProvider.CURRENT_MODEL_VERSION);
	}
