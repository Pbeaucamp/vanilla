...
public class DialogPickCol extends Dialog {
	...
	private HashMap<String, DataObject> mapT = new LinkedHashMap<String, DataObject>();
	private HashMap<String, DataObjectItem> mapI = new LinkedHashMap<String, DataObjectItem>();
	private HashMap<String, DataSource> mapD = new LinkedHashMap<String, DataSource>();

	private DataObjectItem objItem;

	public DialogPickCol(Shell parentShell) {
		super(parentShell);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		l.setText(LanguageText.DialogPickCol_0);
		...
		lb1.setText(LanguageText.DialogPickCol_1);
		...
		lb2.setText(LanguageText.DialogPickCol_2);
	...
	protected void initializeBounds() {
		...
		shell.setText(LanguageText.DialogPickCol_3);
	}
}
