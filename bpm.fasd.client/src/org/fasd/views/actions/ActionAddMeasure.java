...
import org.fasd.views.dialogs.DialogFormula;
...
public class ActionAddMeasure extends Action {
	private MeasureView view;
	private UndoContext undoContext;

	public ActionAddMeasure(MeasureView v, UndoContext undoContext) {
		super(LanguageText.ActionAddMeasure_Add_Measure);
		view = v;
	...
	public void run() {
		MeasureDefinitionDialog dial = new MeasureDefinitionDialog(view.getSite().getShell(), FreemetricsPlugin.getDefault().getFAModel(), null);
