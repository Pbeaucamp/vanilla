...
import bpm.metadata.client.security.compositehelpers.CompositeConnectionHelper;
import bpm.metadata.layer.physical.IConnection;

public class ConnectionPage implements IDetailsPage{

	protected IManagedForm managedForm;
	private CompositeConnectionHelper helper;
	...
	public void createContents(Composite parent) {
		...
		helper = new CompositeConnectionHelper(toolkit, client, SWT.NONE);
		helper.createContent(client);
...
//		toolkit.paintBordersFor(composite);
	...
	public void selectionChanged(IFormPart part, ISelection selection) {
		...
		if (ss.isEmpty()){
			...
			helper.setConnection((IConnection)ss.getFirstElement());
		}
