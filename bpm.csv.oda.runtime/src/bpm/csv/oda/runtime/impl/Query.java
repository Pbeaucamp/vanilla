...
public class Query implements IQuery {
	...
	public void prepare( String queryText ) throws OdaException {
        try {
			...
			Element cols = root.element("columns");
			
			for (Object o : cols.elements("column")) {
				Element e = (Element) o;
				columnIds.add(new Integer(e.getStringValue()));
			}
...
//			throw new OdaException(e.getMessage());
	...
	public int getMaxRows() throws OdaException {
		if (m_maxRows == 0) {
			m_maxRows = ((ResultSetMetaData) getMetaData()).getMaxRow();
		}
		return m_maxRows;
	}
	...
	public String getFilePath() {
		return connection.getTemporaryFile();
	}
	...
	public String getSeparator() {
		return connection.getSeparator();
	}
	
	public String getDateFormat() {
		return connection.getDateFormat();
	}
