...
public class WorkFlowFolderCondition implements Serializable{
	...
	private boolean alertFacture=false;
	...
	public boolean isAlertFacture() {
		return alertFacture;
	}
	public void setAlertFacture(boolean alertFacture) {
		this.alertFacture = alertFacture;
	}
}
