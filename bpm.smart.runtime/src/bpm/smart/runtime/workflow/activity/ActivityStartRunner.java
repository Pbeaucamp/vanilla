...
public class ActivityStartRunner extends ActivityRunner<StartActivity> {

	public ActivityStartRunner(StartActivity activity, WorkflowRunInstance instance, ResourceManager resourceManager) {
