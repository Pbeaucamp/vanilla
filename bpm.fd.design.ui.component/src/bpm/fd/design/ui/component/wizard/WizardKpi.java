...
import bpm.fd.design.ui.component.report.pages.KpiPage;
import bpm.fd.design.ui.wizard.IWizardComponent;
import bpm.vanilla.platform.core.repository.Parameter;
import bpm.vanilla.platform.core.repository.RepositoryItem;

public class WizardKpi extends Wizard implements IWizardComponent{

	private GeneralPage generic;
	private KpiPage reportPage;
	...
	public boolean performFinish() {
		...
		ComponentKpi component = new ComponentKpi(prop.getProperty(GeneralPage.PROPERTY_NAME), dictionaty);
