...
public class WizardTimer extends Wizard implements IWizardComponent{
	...
	public boolean performFinish() {
		...
		ComponentTimer component = new ComponentTimer(prop.getProperty(GeneralPage.PROPERTY_NAME), dictionaty);
...
//		component.setComponentOption(textPage.getOptions());
		...
		try {
			...
			ErrorDialog.openError(getShell(), Messages.WizardTimer_0, Messages.WizardTimer_1, 
