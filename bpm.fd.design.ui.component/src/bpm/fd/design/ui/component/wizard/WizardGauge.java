...
import bpm.fd.design.ui.component.gauge.pages.GaugeDatasPage;
import bpm.fd.design.ui.component.pages.GeneralPage;
import bpm.fd.design.ui.wizard.IWizardComponent;

public class WizardGauge extends Wizard implements IWizardComponent{

	private GeneralPage generic;
	private GaugeDatasPage datasPage;
	...
	public boolean performFinish() {
		...
		ComponentGauge component = new ComponentGauge(prop.getProperty(GeneralPage.PROPERTY_NAME), dictionaty);
		component.setComment(prop.getProperty(GeneralPage.PROPERTY_DESCRIPTION));
				
		try{
			component.setComponentDatas(datasPage.getDatas());
		}catch(Exception e){
			e.printStackTrace();
			return false;
		}
		...
		try {
			...
			ErrorDialog.openError(getShell(), Messages.WizardGauge_0, Messages.WizardGauge_1, 
