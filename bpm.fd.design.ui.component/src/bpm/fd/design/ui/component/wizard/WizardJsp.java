...
public class WizardJsp extends Wizard implements IWizardComponent{
	...
	public boolean performFinish() {
		...
		ComponentJsp component = new ComponentJsp(prop.getProperty(GeneralPage.PROPERTY_NAME), dictionaty);
		...
		component.setJspUrl(urlPage.getUrl());
