...
public class WizardD4c extends Wizard implements IWizardComponent{
	...
	public boolean performFinish() {
		...
		ComponentD4C component = new ComponentD4C(prop.getProperty(GeneralPage.PROPERTY_NAME), dictionaty);
