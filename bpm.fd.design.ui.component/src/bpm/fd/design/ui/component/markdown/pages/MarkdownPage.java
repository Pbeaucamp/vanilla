package bpm.fd.design.ui.component.markdown.pages;
...
public class MarkdownPage extends WizardPage{
	public static final String PAGE_NAME = "bpm.fd.design.ui.component.markdown.pages.MarkdownPage"; //$NON-NLS-1$
	public static final String PAGE_TITLE = Messages.MarkdownPage_1;
	public static final String PAGE_DESCRIPTION = Messages.MarkdownPage_2;
	...
	protected MarkdownPage(String pageName) {
		super(pageName);
	}
...
//				connectAction.run(null);
				...
				if (bpm.fd.repository.ui.Activator.getDefault().getRepositoryConnection() == null){
					MessageDialog.openInformation(getShell(), Messages.MarkdownPage_3, Messages.MarkdownPage_4);
					return;
				}
			}
		...
		viewer.addFilter(new ViewerFilter() {
			...
			public boolean select(Viewer viewer, Object parentElement, Object element) {
				if (element instanceof RepositoryItem){
					return ((RepositoryItem)element).getType() == IRepositoryApi.R_MARKDOWN_TYPE;
				}
				return true;
			}
		});
