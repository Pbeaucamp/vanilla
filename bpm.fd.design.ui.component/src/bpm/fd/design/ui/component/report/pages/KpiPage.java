...
public class KpiPage extends WizardPage{
	public static final String PAGE_NAME = "bpm.fd.design.ui.component.kpi.pages.KpiPage"; //$NON-NLS-1$
	...
	protected KpiPage(String pageName) {
		super(pageName);
	}
		...
		viewer.addFilter(new ViewerFilter() {
			...
			public boolean select(Viewer viewer, Object parentElement, Object element) {
				if (element instanceof RepositoryItem){
					return ((RepositoryItem)element).getType() == IRepositoryApi.KPI_THEME;
				}
				return true;
			}
		});
