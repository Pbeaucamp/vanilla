...
public class CompositeVanillaMap implements ICompositeMapDefinition {
	...
	public Composite createContent(Composite parent) {
		...
		l.setText(Messages.CompositeVanillaMap_0);
		...
		browse.setText(Messages.CompositeVanillaMap_2);
		browse.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				try{
					fusionMapObjects.setInput(reg.getFusionMapObjects(IFusionMapObject.VANILLAMAP_TYPE));
				}catch(Exception ex){
					ex.printStackTrace();
					MessageDialog.openError(client.getShell(), Messages.CompositeVanillaMap_3, Messages.CompositeVanillaMap_4 + ex.getMessage());
				}
			}
		});
		...
		l.setLayoutData(new GridData(GridData.BEGINNING, GridData.CENTER, false, false));
		l.setText(Messages.CompositeVanillaMap_5);
		...
		l.setText(Messages.CompositeVanillaMap_6);
	...
	public void init(IMapInfo inf) {
		...
		if (inf == null){
			...
			try{
				...
				ex.printStackTrace();
				MessageDialog.openError(client.getShell(), Messages.CompositeVanillaMap_8, Messages.CompositeVanillaMap_9 + ex.getMessage());
			}	
		}
