...
/**
 * Cancel activity (not implemented)
 * @author Charles MARTIN
 *
 */
public class CancelActivity extends AbstractActivity {
	...
	public CancelActivity(String name) {
	...
	public IActivity copy() {
		CancelActivity a = new CancelActivity();
