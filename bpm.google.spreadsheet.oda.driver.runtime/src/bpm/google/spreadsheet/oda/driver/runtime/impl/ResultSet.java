...
public class ResultSet implements IResultSet
{
    ...
    private OdaGoogleSheet resultSetSheet;
	
	public ResultSet(OdaGoogleSheet sheetSelected) {
		resultSetSheet = sheetSelected;
	}
	...
	public IResultSetMetaData getMetaData() throws OdaException
	{
		...
		return new ResultSetMetaData(resultSetSheet);
	}
	...
	{
		m_maxRows = resultSetSheet.getSheetCountRow();
	}
	...
	public String getString( int index ) throws OdaException
	{
        ...
        return resultSetSheet.getSheetListRow().get(m_currentRowId-1).getRowListCell().get(index-1);
	}
	...
	public int getInt( int index ) throws OdaException
	{
		...
		Object obj = resultSetSheet.getSheetListRow().get(m_currentRowId-1).getRowListCell().get(index-1);
    ...
    public int findColumn( String columnName ) throws OdaException
    {
    	...
    	if(resultSetSheet.getSheetListCol() != null) {
    		for(OdaGoogleSheetColumn col : resultSetSheet.getSheetListCol()) {
