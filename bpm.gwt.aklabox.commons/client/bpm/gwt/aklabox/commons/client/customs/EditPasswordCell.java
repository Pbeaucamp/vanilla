...
public class EditPasswordCell extends AbstractEditableCell<String, EditPasswordCell.ViewData> {
	 ...
	 */
	public EditPasswordCell(SafeHtmlRenderer<String> renderer) {
