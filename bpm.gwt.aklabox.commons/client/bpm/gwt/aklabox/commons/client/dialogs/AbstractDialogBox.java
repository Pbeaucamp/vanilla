...
public abstract class AbstractDialogBox implements IWait {
	...
	public BaseDialogBox getDialog() {
		return dialog;
	}

	public void setDialog(BaseDialogBox dialog) {
		this.dialog = dialog;
	}
