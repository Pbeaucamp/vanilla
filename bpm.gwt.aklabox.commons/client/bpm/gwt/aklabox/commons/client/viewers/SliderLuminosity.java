...
public class SliderLuminosity extends Composite {

	private static SliderLuminosityUiBinder uiBinder = GWT.create(SliderLuminosityUiBinder.class);

	interface SliderLuminosityUiBinder extends UiBinder<Widget, SliderLuminosity> {
	}
	...
	public SliderLuminosity(Image imgPreview, boolean isImage) {
...
//		imgPreview.setHeight((100 + (slider.getCurrentValue() - 50)) + "%");
	}
