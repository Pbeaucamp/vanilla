...
public class DialogRepository extends Dialog {
	...
	private Text userName, password, url;
	...
	protected Control createDialogArea(Composite parent) {
		...
		_tip1.setLayoutData(new GridData(GridData.BEGINNING, GridData.CENTER, true, false, 3, 1));
		_tip1.setText(""); //$NON-NLS-1$
		
		Label tip1 = new Label(content, SWT.NONE);
		tip1.setLayoutData(new GridData(GridData.BEGINNING, GridData.CENTER, true, false, 3, 1));
		...
		tip2.setLayoutData(new GridData(GridData.BEGINNING, GridData.CENTER, true, false, 3, 1));
	...
	private void initRepositories() {
		try {
			...
			MessageDialog.openError(getShell(), Messages.DialogRepository_10, Messages.DialogRepository_11 + e.getMessage());
			authentified = false;
		}
		updateConnectButton();
	}
