...
public class Driver implements IDriver {
	public static String ODA_DATA_SOURCE_ID = "bpm.weka.oda.runtime"; //$NON-NLS-1$
	
	public static String PROP_USER = "USER";
	public static String PROP_PASSWORD = "PASSWORD";
	public static String PROP_REPID = "REPID";
	public static String PROP_GROUPID = "GROUPID";
	public static String PROP_ITEMID = "ITEMID";
	public static String PROP_URL = "URL";
	
	public static String PROP_LOCAL_FILE = "LOCALFILE";
