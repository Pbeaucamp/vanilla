...
public class FileShapeProperties extends DataStreamProperties {
		
	public FileShapeProperties(Node node) {
		super(node);
	...
	public Object getPropertyValue(Object id) {
		...
		if (id.equals(PROPERTY_SERVER)){
			return ((FileShape)node.getGatewayModel()).getServer();
		}
		if (id.equals(PROPERTY_SQL_DEFINITION)){
			return ((FileShape)node.getGatewayModel()).getDefinition();
		}
		return null;
	}
	...
	public boolean isPropertySet(Object id) {
		...
		if (id.equals(PROPERTY_SQL_DEFINITION)){
			return ((FileShape)node.getGatewayModel()).getDefinition() == null;
		}
	...
	public void setPropertyValue(Object id, Object value) {
		if (id.equals(PROPERTY_SERVER)){
			((FileShape)node.getGatewayModel()).setServer((AbstractFileServer)value);
		}
		if (id.equals(PROPERTY_SQL_DEFINITION)){
			((FileShape)node.getGatewayModel()).setDefinition((String)value);
		}
