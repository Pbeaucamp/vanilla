...
public class HBaseDefinitionSection extends AbstractPropertySection {

	private HbaseInputStream model;
	
	private Text txtTableName;
	private Text txtColumnFamily;
	
	public HBaseDefinitionSection() { }
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
        ...
        this.model = (HbaseInputStream)((Node)((NodePart) input).getModel()).getGatewayModel();
	}
	...
	public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
		...
		Label lblTableName = getWidgetFactory().createLabel(composite, Messages.HBaseDefinitionSection_0);
		...
		Label lblColumnFamily = getWidgetFactory().createLabel(composite, Messages.HBaseDefinitionSection_1);
		...
		bBrowse.addSelectionListener(new SelectionAdapter(){
			...
			public void widgetSelected(SelectionEvent e) {
				...
				try {
					...
					if (model instanceof HbaseInputStream){
						lst = HBaseHelper.getValues(model, 100);
					}
