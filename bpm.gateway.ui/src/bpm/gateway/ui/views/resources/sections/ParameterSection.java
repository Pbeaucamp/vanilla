...
import bpm.gateway.ui.composites.CompositeParameter;

public class ParameterSection extends AbstractPropertySection {

	private CompositeParameter composite;
	...
	public void createControls(Composite parent,
		...
		composite = new CompositeParameter(container, SWT.NONE);
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
        ...
        this.parameter = ((Parameter) input);
	}

	@Override
	public void refresh() {
	
		composite.fillDatas(parameter);
...
//		composite.releaseListeners();
//		super.aboutToBeHidden();
//	}
//
//	@Override
//	public void aboutToBeShown() {
//		composite.attachListeners();
