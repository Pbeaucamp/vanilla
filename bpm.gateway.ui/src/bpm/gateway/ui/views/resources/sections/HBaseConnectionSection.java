...
public class HBaseConnectionSection extends AbstractPropertySection {
	
	private HBaseConnection dataBaseConnection;

	private HBaseConnectionComposite compositeConnection;
	...
	public void createControls(Composite parent, TabbedPropertySheetPage aTabbedPropertySheetPage) {
		...
		compositeConnection = new HBaseConnectionComposite(composite, SWT.NONE, null);
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
        ...
        Assert.isTrue(input instanceof HBaseConnection);
        this.dataBaseConnection = ((HBaseConnection) input);
	}
