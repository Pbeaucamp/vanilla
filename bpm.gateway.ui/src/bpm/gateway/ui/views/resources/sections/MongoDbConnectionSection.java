...
public class MongoDbConnectionSection extends AbstractPropertySection {

	private MongoDbConnection dataBaseConnection;

	private MongoDbConnectionComposite compositeConnection;
	...
	public void createControls(Composite parent,
		...
		compositeConnection = new MongoDbConnectionComposite(composite, SWT.NONE, null);
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
        ...
        Assert.isTrue(input instanceof MongoDbConnection);
        this.dataBaseConnection = ((MongoDbConnection) input);
	}
}
