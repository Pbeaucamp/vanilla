...
public class DialogOracleViewDefinition extends Dialog {
	...
	public DialogOracleViewDefinition(Shell parentShell, OracleXmlView fileXML) {
		super(parentShell);
	...
	private void buildTreeColumn() {
		...
		colXSD.getColumn().setText(Messages.DialogOracleViewDefinition_7);
		...
		colType.getColumn().setText(Messages.DialogOracleViewDefinition_9);
		...
		colOutput.getColumn().setText(Messages.DialogOracleViewDefinition_11);
		...
		colColumnID.getColumn().setText(Messages.DialogOracleViewDefinition_13);
	...
	protected void initializeBounds() {
		...
		getShell().setText(Messages.DialogOracleViewDefinition_16);
	...
	private ITreeContentProvider xsdContentProvider = new ITreeContentProvider() {
		...
		public Object[] getElements(Object inputElement) {
			if (inputElement instanceof OracleXmlView) {
		...
		public Object[] getChildren(Object parentElement) {
			if (parentElement instanceof DefinitionXSD) {
				...
				// List<AttributeXSD> attrs = ((DefinitionXSD)
