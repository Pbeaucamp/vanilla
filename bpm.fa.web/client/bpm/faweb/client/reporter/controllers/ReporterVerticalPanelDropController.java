...
import bpm.faweb.client.gwt.dnd.client.drop.AbstractInsertPanelDropController;
import bpm.faweb.client.gwt.dnd.client.util.CoordinateLocation;
import bpm.faweb.client.gwt.dnd.client.util.DOMUtil;
import bpm.faweb.client.gwt.dnd.client.util.DragClientBundle;
import bpm.faweb.client.gwt.dnd.client.util.LocationWidgetComparator;
...
public class ReporterVerticalPanelDropController extends AbstractInsertPanelDropController {
	...
	*/
	...
	public ReporterVerticalPanelDropController(CrossTabCell dropTarget) {
		super(dropTarget);
