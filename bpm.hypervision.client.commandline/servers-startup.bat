...
java -cp  %LIBS% %CLASS% start REPORTING http://localhost:8080/VanillaRuntime system system
java -cp  %LIBS% %CLASS% start GATEWAY http://localhost:8080/VanillaRuntime system system
java -cp  %LIBS% %CLASS% start FREEMETADATA http://localhost:8080/VanillaRuntime system system
