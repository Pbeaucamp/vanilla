...
public class MemcacheConnectionFactory extends DefaultConnectionFactory{
	
	class Transcode extends SerializingTranscoder{
...
//						o.getClass().getName(), b.length, compressed.length);
		...
		@Override
		protected byte[] decompress(byte[] arg0) {
			
			return arg0;
		}
		
		@Override
		protected byte[] compress(byte[] arg0) {
	...
	private Transcode t = new Transcode();
//	@Override
