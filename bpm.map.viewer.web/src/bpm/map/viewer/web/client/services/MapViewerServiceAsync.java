...
public interface MapViewerServiceAsync {
	...
	void exportToImage(String name, String content, String type, AsyncCallback<String> callback);

	void exportToPdf(String title, String text, String author, String img, String type, AsyncCallback<String> callback);
}
