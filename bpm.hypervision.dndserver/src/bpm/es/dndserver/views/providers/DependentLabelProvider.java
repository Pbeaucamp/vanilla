...
public class DependentLabelProvider extends LabelProvider{
	...
	public Image getImage(Object obj) {
		...
		if (obj instanceof RepositoryItem) {
			...
			AxisDirectoryItemWrapper it = (AxisDirectoryItemWrapper)obj;
			String key = getKeyForType(it.getAxisItem().getType(), it.getAxisItem());
			return reg.get(key);
