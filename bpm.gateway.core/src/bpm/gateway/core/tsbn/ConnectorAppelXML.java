...
import bpm.gateway.runtime2.transformation.tsbn.RunConnectorAppel;
import bpm.vanilla.platform.core.IRepositoryContext;

public class ConnectorAppelXML extends AbstractTransformation implements DataStream {
	...
	public Element getElement() {
		Element e = DocumentHelper.createElement("connectorAppelXML");
	...
	public RuntimeStep getExecutioner(IRepositoryContext repositoryCtx, int bufferSize) {
		return new RunConnectorAppel(this, bufferSize);
	}
	...
	public Transformation copy() {
		ConnectorAppelXML copy = new ConnectorAppelXML();
