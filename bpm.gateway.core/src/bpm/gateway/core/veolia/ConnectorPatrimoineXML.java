...
import bpm.gateway.runtime2.transformation.veolia.RunConnectorPatrimoine;
import bpm.vanilla.platform.core.IRepositoryContext;

public class ConnectorPatrimoineXML extends ConnectorXML {

	@Override
	public Element getElement() {
		Element e = DocumentHelper.createElement("connectorPatrimoineXML");
	...
	public RuntimeStep getExecutioner(IRepositoryContext repositoryCtx, int bufferSize) {
		try {
			return new RunConnectorPatrimoine(repositoryCtx, this, bufferSize);
		} catch (Exception e) {
	...
	public Transformation copy() {
		ConnectorPatrimoineXML copy = new ConnectorPatrimoineXML();
