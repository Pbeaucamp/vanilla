package bpm.document.management.manager.remote.internal;
...
import bpm.document.management.manager.core.IVdmAdminConstant;
import bpm.document.management.manager.core.IVdmAdminManager;
import bpm.document.management.manager.core.xstream.SessionExpiredException;
...
public class HttpCommunicator extends AbstractRemoteAuthentifier{
	...
	public String executeAction(XmlAction action, String message) throws Exception{
		if (action.getActionType() instanceof IVdmAdminManager.ActionType){
			return sendMessage(IVdmAdminConstant.MOBILE_SERVLET, message);
		}
	...
	public InputStream executeActionAsStream(XmlAction action, String message) throws Exception{
		if (action.getActionType() instanceof IVdmAdminManager.ActionType){
			return sendMessageForStream(IVdmAdminConstant.MOBILE_SERVLET, message);
		}
