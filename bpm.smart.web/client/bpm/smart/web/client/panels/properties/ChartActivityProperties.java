...
public class ChartActivityProperties extends PropertiesPanel<Activity> {

	private ChartOutputActivity activity;
	...
	public ChartActivityProperties(IResourceManager resourceManager, WorkspacePanel creationPanel, BoxItem item, ChartOutputActivity chartActivity) {
		super(resourceManager, LabelsCommon.lblCnst.Name(), WidgetWidth.PCT, 0, chartActivity.getName(), true, false);
		...
		addButton(LabelsConstants.lblCnst.RefreshWorkflow(), new RefreshWorkflowHandler(creationPanel, chartActivity));
