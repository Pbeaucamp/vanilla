...
public class KpiEntityCollectionProcessor implements EntityCollectionProcessor {

	private OpenDataComponent component;
	private OData odata;
	private ServiceMetadata serviceMetadata;

	public KpiEntityCollectionProcessor(OpenDataComponent component) {
	...
	public void readEntityCollection(ODataRequest request, ODataResponse response, UriInfo uriInfo, ContentType responseFormat) throws ODataApplicationException, SerializerException {
		...
		SegmentResponse segmentResponse = manageSegments(resourceParts, startEdmEntitySet, filterExpression);
	...
	private SegmentResponse manageSegments(List<UriResource> resourceParts, EdmEntitySet startEdmEntitySet, Expression filterExpression) throws ODataApplicationException {
		...
		entityCollection = component.getDataManager().readEntitySetData(entitySet, keys, filterExpression);
