...
public class StrategiesAdapterFactory extends AdapterFactoryImpl {
	...
	protected StrategiesSwitch<Adapter> modelSwitch =
		new StrategiesSwitch<Adapter>() {
			@Override
			public Adapter caseDefaultStrategy(DefaultStrategy object) {
				return createDefaultStrategyAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link bpm.mdm.model.strategies.DefaultStrategy <em>Default Strategy</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDefaultStrategyAdapter() {
		return null;
	}
