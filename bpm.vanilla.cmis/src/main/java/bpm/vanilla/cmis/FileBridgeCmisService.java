...
public class FileBridgeCmisService extends AbstractCmisService implements CallContextAwareCmisService {
     ...
     */
    public VanillaBridgeRepository getRepository() {
        return repositoryManager.getRepository(getCallContext().getRepositoryId(), ((FileBridgeCallContext) getCallContext()).getVanillaApi(), ((FileBridgeCallContext) getCallContext()).getGedComponent(), 
        		((FileBridgeCallContext) getCallContext()).getCurrentUser(), ((FileBridgeCallContext) getCallContext()).getCurrentGroup(), ((FileBridgeCallContext) getCallContext()).getCurrentRepository());
    }
    ...
    public RepositoryInfo getRepositoryInfo(String repositoryId, ExtensionsData extension) {
        for (VanillaBridgeRepository fsr : repositoryManager.getRepositories()) {
