...
/**
 * Dialog for the type of the link activities
 * 
 * @author Charles MARTIN
 * 
 */
public class DialogLinkIcon extends Dialog {
	...
	public DialogLinkIcon(Shell parentShell) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(Messages.DialogLinkIcon_2);
		...
		lab.setImage(Activator.getDefault().getImageRegistry().get(IconsNames.LINKIMAGE));
		...
		lab.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				type = "link"; //$NON-NLS-1$
				textfield.setText(Messages.DialogLinkIcon_4);
		...
		lab1.setImage(Activator.getDefault().getImageRegistry().get(IconsNames.LINKREIMAGE));
		...
		lab1.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				type = "linkre"; //$NON-NLS-1$
				textfield.setText(Messages.DialogLinkIcon_7);
