...
/**
 * Dialo for the type of the signal activities
 * 
 * @author Charles MARTIN
 * 
 */
public class DialogSignalIcon extends Dialog {

	public String type = ""; //$NON-NLS-1$
	public String typeact = ""; //$NON-NLS-1$

	public DialogSignalIcon(Shell parentShell) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(Messages.DialogSignalIcon_2);
		...
		lab.setImage(Activator.getDefault().getImageRegistry().get(IconsNames.SIGNALIMAGE));
		...
		lab.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				type = "signal"; //$NON-NLS-1$
				textfield.setText(Messages.DialogSignalIcon_4);
		...
		lab1.setImage(Activator.getDefault().getImageRegistry().get(IconsNames.SIGNALREIMAGE));
		...
		lab1.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				type = "signalre"; //$NON-NLS-1$
				textfield.setText(Messages.DialogSignalIcon_7);
