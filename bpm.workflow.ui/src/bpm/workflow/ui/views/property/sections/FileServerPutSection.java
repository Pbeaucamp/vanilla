...
/**
 * Section for the put... activities (file management)
 * 
 * @author Charles MARTIN
 * 
 */
public class FileServerPutSection extends AbstractPropertySection {
	private Combo server;

	private Node node;

	public FileServerPutSection() {}
	...
	public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
		...
		general.setText(Messages.FileServerPutSection_0);

		CLabel labelLabel = getWidgetFactory().createCLabel(general, Messages.FileServerPutSection_1);
	...
	public void refresh() {
		...
		// List<Server> servers2 = ListServer.getInstance().getServers();
		// List<Server> temp2 = new ArrayList<Server>();
		// for (Server s : servers2) {
		// if (s.getClass() == BiRepository.class) {
		// temp2.add(s);
		// }
		// }
		...
		public void widgetSelected(SelectionEvent e) {
			...
			if(server.getText() != null) {
				...
				if(s != null && s instanceof FileServer) {
					((IFileServerPut) node.getWorkflowObject()).setServer(s);
