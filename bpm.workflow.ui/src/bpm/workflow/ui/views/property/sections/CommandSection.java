...
public class CommandSection extends AbstractPropertySection {
	...
	public void refresh() {
		...
		if (((ICommand) node.getWorkflowObject()).getCommand() != null) {
			selectH.setText(((ICommand) node.getWorkflowObject()).getCommand());
		}
		else {
	...
	private ModifyListener listener = new ModifyListener() {
		...
		public void modifyText(ModifyEvent evt) {
			((ICommand) node.getWorkflowObject()).setCommand(selectH.getText());
		}
	};
