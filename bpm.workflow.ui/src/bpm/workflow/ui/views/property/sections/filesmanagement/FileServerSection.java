 ...
 * 
 */
public class FileServerSection extends AbstractPropertySection {
	private Combo server;
	private Node node;
	private Composite composite;

	public FileServerSection() {}
	...
	public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
		...
		CLabel labelLabel = getWidgetFactory().createCLabel(composite, Messages.FileServerSection_0);
	...
	public void aboutToBeHidden() {
		// server.removeSelectionListener(adaptder);
	...
	SelectionAdapter adaptder = new SelectionAdapter() {
		...
		public void widgetSelected(SelectionEvent e) {
			...
			if(s != null) {
				((IServer) node.getWorkflowObject()).setServer(s);
