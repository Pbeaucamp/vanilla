...
public class ToolBoxCategory extends StackNavigationPanel {
	...
	public ToolBoxCategory(CollapsePanel collapsePanel, String title, boolean showCollapse, List<ToolBox> tools, String backgroundColor) {
	...
	public StackHeader buildHeader() {
		return new StackHeader(collapsePanel, title, showCollapse, 0, backgroundColor);
	}
}
