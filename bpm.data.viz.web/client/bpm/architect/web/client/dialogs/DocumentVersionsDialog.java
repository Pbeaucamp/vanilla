...
public class DocumentVersionsDialog extends AbstractDialogBox implements DatagridHandler<DocumentVersion> {
	...
	private void updateToolbar(boolean visible) {
		btnSetAsCurrent.setVisible(visible);
	}

	@UiHandler("btnSetAsCurrent")
	public void onSetAsCurrent(ClickEvent event) {
		DocumentVersion version = selectionModel.getSelectedObject();
		if (version == null) {
			return;
		}
