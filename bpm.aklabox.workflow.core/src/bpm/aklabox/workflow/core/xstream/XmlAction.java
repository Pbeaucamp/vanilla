...
/**
 * a Simple class to represent an Action to be performed by the server side of
 * the vanilla forms
 * 
 * The server side is implemented by the plugin bpm.forms.runtime and contains
 * Servlets Each servlets will received orders by the form of an serialized
 * XmlAction and rebuild the XmAction object from teh XML
 * 
 * @author ludo
 * 
 */
public class XmlAction {
	 ...
	 * 
	 * @param arguments
	 *            : object will contains all the parameters objects for the
	 *            action
	 * @param actionType
	 *            : the action type
	 */
