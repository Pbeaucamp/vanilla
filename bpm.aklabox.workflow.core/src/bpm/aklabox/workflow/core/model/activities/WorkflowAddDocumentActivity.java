...
public class WorkflowAddDocumentActivity extends Activity implements IAklaBoxServer, IFileName {
...
//	private int aklaboxServer = 0;
	...
	public WorkflowAddDocumentActivity(String activityId, String activityName, int workflowId, int posX, int posY, int listIndex, String address, String fileName/*, int aklaboxServer*/) {
		super();
...
//		this.aklaboxServer = aklaboxServer;
	...
	public WorkflowAddDocumentActivity() {
		this.activityId = "workflowAddDocumentActivity";
		this.activityName = "Add Workflow Document";
	}
