...
public class ValidateByDocumentActivity extends Activity implements IAklaBoxServer, IFileName {
...
//	private int aklaboxServer = 0;
	...
	public ValidateByDocumentActivity(String activityId, String activityName, int workflowId, int posX, int posY, int listIndex, String address, String fileName/*, int aklaboxServer*/) {
		super();
...
//		this.aklaboxServer = aklaboxServer;
	...
	public ValidateByDocumentActivity() {
		this.activityId = "validatebyDocumentActivity";
		this.activityName = "Validated by";
	}
