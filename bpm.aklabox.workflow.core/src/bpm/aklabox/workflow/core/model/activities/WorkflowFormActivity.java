...
public class WorkflowFormActivity extends Activity implements IAklaBoxServer, IFileName {
...
//	private int aklaboxServer = 0;
	...
	public WorkflowFormActivity(String activityId, String activityName, int workflowId, int posX, int posY, int listIndex, String address, String fileName/*, int aklaboxServer*/) {
		super();
...
//		this.aklaboxServer = aklaboxServer;
	...
	public WorkflowFormActivity() {
		this.activityId = "workflowFormActivity";
		this.activityName = "Workflow Form";
	}
