...
public class WorkflowChangeDateActivity extends Activity implements IAklaBoxServer, IFileName {
...
//	private int aklaboxServer = 0;
	...
	public WorkflowChangeDateActivity(String activityId, String activityName, int workflowId, int posX, int posY, int listIndex, String address, String fileName/*, int aklaboxServer*/) {
		super();
...
//		this.aklaboxServer = aklaboxServer;
	...
	public WorkflowChangeDateActivity() {
		this.activityId = "workflowChangeDateActivity";
		this.activityName = "Change Workflow Date";
	}
