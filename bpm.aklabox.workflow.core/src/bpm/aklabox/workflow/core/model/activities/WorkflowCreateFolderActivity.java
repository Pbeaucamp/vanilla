...
public class WorkflowCreateFolderActivity extends Activity implements IAklaBoxServer, IFileName {
...
//	private int aklaBoxDirectory = 0;
	...
	public WorkflowCreateFolderActivity(String activityId, String activityName, int workflowId, int posX, int posY, int listIndex, String address, String fileName/*, int aklaboxServer*/) {
		super();
...
//		this.aklaboxServer = aklaboxServer;
	...
	public WorkflowCreateFolderActivity() {
		this.activityId = "workflowCreateFolderActivity";
		this.activityName = "Create Workflow Folder";
	}
