...
public class VanillaStarter extends Activity implements IVanilla{
	...
	public VanillaStarter() {
		this.activityId = "vanillaStarter";
		this.activityName = "Starter";
	}
	
	public VanillaStarter(String activityId, String activityName, int workflowId, int posX, int posY, int listIndex) {
		super();
