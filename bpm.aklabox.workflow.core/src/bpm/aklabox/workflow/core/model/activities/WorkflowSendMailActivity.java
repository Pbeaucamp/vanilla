...
public class WorkflowSendMailActivity extends Activity implements IAklaBoxServer, IFileName {
...
//	private int aklaboxServer = 0;
	...
	public WorkflowSendMailActivity(String activityId, String activityName, int workflowId, int posX, int posY, int listIndex, String address, String fileName/*, int aklaboxServer*/) {
		super();
...
//		this.aklaboxServer = aklaboxServer;
	...
	public WorkflowSendMailActivity() {
		this.activityId = "workflowSendMailActivity";
		this.activityName = "Send Mail Workflow";
	}
