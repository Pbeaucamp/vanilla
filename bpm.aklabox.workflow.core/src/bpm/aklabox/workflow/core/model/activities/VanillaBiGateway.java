...
public class VanillaBiGateway extends Activity implements IVanilla{
	...
	public VanillaBiGateway() {
		this.activityId = "vanillaBiGateway";
		this.activityName = "Bi Gateway";
	}
	
	public VanillaBiGateway(String activityId, String activityName, int workflowId, int posX, int posY, int listIndex) {
		super();
