...
public class VanillaSql extends Activity implements IVanilla{
	...
	public VanillaSql() {
		this.activityId = "vanillaSql";
		this.activityName = "SQL Query";
	}
	
	public VanillaSql(String activityId, String activityName, int workflowId, int posX, int posY, int listIndex) {
		super();
