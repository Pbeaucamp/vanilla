...
public class DateTreatmentDocumentActivity extends Activity implements IAklaBoxServer, IFileName {
...
//	private int aklaboxServer = 0;
	...
	public DateTreatmentDocumentActivity(String activityId, String activityName, int workflowId, int posX, int posY, int listIndex, String address, String fileName/*, int aklaboxServer*/) {
		super();
...
//		this.aklaboxServer = aklaboxServer;
	...
	public DateTreatmentDocumentActivity() {
		this.activityId = "treatmentDateDocumentActivity";
		this.activityName = "Treatment Date";
	}
