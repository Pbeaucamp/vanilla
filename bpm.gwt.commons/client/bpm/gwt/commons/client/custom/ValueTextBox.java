...
import bpm.gwt.commons.client.utils.StringUtils;
 ...
 */
public class ValueTextBox extends TextHolderBox {
	...
	protected String formatValue(long value) {
		...
		if (minDigits > newValue.length()) {
			String leading = StringUtils.repeat("0", (minDigits - newValue.length()));
