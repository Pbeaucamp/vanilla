 ...
 *
 */
public class EnableDisableableCheckboxCell extends AbstractEditableCell<CheckState, CheckState> {
	 ...
	 */
	public EnableDisableableCheckboxCell() {
		this(false);
	}
	 ...
	 */
	@Deprecated
	public EnableDisableableCheckboxCell(boolean isSelectBox) {
	 ...
	 */
	public EnableDisableableCheckboxCell(boolean dependsOnSelection, boolean handlesSelection) {
