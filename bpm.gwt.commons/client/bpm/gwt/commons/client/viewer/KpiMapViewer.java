...
public class KpiMapViewer extends Viewer {

	private LaunchReportInformations itemInfo;
	
	private String kpiUrl;

	public KpiMapViewer(VanillaViewer vanillaViewer, PortailRepositoryItem item, Group selectedGroup, List<Group> availableGroups) {
		super(vanillaViewer);
...
//		btnRun.setVisible(true);
	...
	public void runItem(final LaunchReportInformations itemInfo) {
		...
		ReportingService.Connect.getInstance().getForwardUrlForKpiMap(itemInfo.getItem(), new GwtCallbackWrapper<String>(this, true) {
