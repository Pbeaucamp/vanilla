...
public class MdmPanel extends Composite {

	private static MailPanelUiBinder uiBinder = GWT.create(MailPanelUiBinder.class);
	
	interface MailPanelUiBinder extends UiBinder<Widget, MdmPanel> {
	}
	...
	public MdmPanel(IWait waitPanel, MdmActivity activity) {
	...
	public void refresh(ClickEvent event) {
		ResourcesServiceImpl.Connect.getInstance().getContracts(null, new GwtCallbackWrapper<List<Contract>>(waitPanel, true, true) {
	...
	private Handler selectionChange = new Handler() {
		...
		public void onSelectionChange(SelectionChangeEvent event) {
			...
			activity.setContractId(contract.getId());
			activity.setContractName(contract.getName());
		}
	};
}
