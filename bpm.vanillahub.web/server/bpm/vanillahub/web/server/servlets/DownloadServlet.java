...
import bpm.vanillahub.core.Formats;
...
//		String name = req.getParameter(Constants.KEY_STREAM);
//		String name = req.getParameter(Constants.KEY_FORMAT);
//
//		try {
//			CommonSession session = getSession(req);
//			ObjectInputStream objIS = session.getStreamAndRemove(name);
//			
//			String format = objIS.getFormat();
//			InputStream is = objIS.getStream();
//			
//			if (format != null) {
//				String mime = "";
