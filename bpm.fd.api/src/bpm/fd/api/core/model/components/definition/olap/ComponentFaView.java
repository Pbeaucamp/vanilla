...
public class ComponentFaView  implements IComponentDefinition, IRepositoryObjectReference{
	...
	public ComponentFaView(String name, Dictionary owner){
		this.name = name;
		this.dictionary = owner;
		
		ReportOptions opts = new ReportOptions();
		options.add(opts);
		FaViewOption faOpts = new FaViewOption();
		options.add(faOpts);
	...
	public Element getElement() {
		Element e = DocumentHelper.createElement("olapView");
	...
	public int[] getObjectType() {
		return new int[]{IRepositoryApi.FAV_TYPE};
	}
	...
	public IComponentDefinition copy() {
		ComponentFaView copy = new ComponentFaView("Copy_of_" + name, dictionary);
