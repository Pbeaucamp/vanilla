...
public class ComponentD4C implements IComponentDefinition {
	...
	public ComponentD4C(String name, Dictionary dictionary) {
		this.dictionary = dictionary;
		this.name = name;
		options.add(new D4COptions());
	...
	public Element getElement() {
		Element e = DocumentHelper.createElement("d4c");
		...
		if (getUrl() != null) {
			e.addElement("d4cUrl").setText(getUrl() + "");
		}
	...
	public IComponentDefinition copy() {
		ComponentD4C copy = new ComponentD4C("Copy_of_" + name, dictionary);
