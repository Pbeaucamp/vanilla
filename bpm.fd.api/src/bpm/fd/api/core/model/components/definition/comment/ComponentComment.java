...
public class ComponentComment implements IComponentDefinition {
	private String name;
	...
	private CommentRenderer renderer = new CommentRenderer();
	
	public void setRenderer(CommentRenderer renderer) {
	...
	public ComponentComment(String name, Dictionary owner){
		this.name = name;
		this.dictionary = owner;

		options.add(new CommentOptions());
	...
	public IComponentDefinition copy() {
		ComponentComment copy = new ComponentComment("Copy_of_" + name, dictionary);
