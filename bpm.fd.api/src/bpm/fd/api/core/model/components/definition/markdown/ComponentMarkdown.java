package bpm.fd.api.core.model.components.definition.markdown;
...
public class ComponentMarkdown implements IComponentDefinition, IRepositoryObjectReference{
	...
	public ComponentMarkdown(String name, Dictionary owner){
		this.name = name;
	...
	public Element getElement() {
		Element e = DocumentHelper.createElement("markdown");
	...
	public IComponentDefinition copy() {
		ComponentMarkdown copy = new ComponentMarkdown("Copy_of_" + name, dictionary);
