...
public class ComponentJsp implements IComponentDefinition{
	...
	/**
	 * @param jspUrl the jspUrl to set
	 */
	public void setJspUrl(String jspUrl) {
		this.jspUrl = jspUrl;
	}

	public ComponentJsp(String name, Dictionary dictionary) {
		this.dictionary = dictionary;
		this.name = name;
		options.add(new JspOptions());
	...
	public Element getElement() {
		Element e = DocumentHelper.createElement("jsp");
		...
		if (getJspUrl() != null){
			e.addElement("jspUrl").setText(getJspUrl() + "");
		}
	...
	public IComponentDefinition copy() {
		ComponentJsp copy = new ComponentJsp("Copy_of_" + name, dictionary);
