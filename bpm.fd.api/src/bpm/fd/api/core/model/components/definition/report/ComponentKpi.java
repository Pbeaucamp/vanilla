...
public class ComponentKpi implements IComponentDefinition, IRepositoryObjectReference{
	...
	public ComponentKpi(String name, Dictionary owner){
		this.name = name;
		...
		ComponentParameter p = new ReportComponentParameter("date", 0);
		addComponentParameter(p);
	...
	public Element getElement() {
		Element e = DocumentHelper.createElement("kpi");
	...
	public int[] getObjectSubtypes() {
		return new int[]{IRepositoryApi.KPI_THEME};
	}
	...
	public IComponentDefinition copy() {
		ComponentKpi copy = new ComponentKpi("Copy_of_" + name, dictionary);
