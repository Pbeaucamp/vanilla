package bpm.fd.api.core.model.components.definition.image;
...
public class ComponentPicture implements IComponentDefinition{
	private String name;
	private String url;
	...
	public ComponentPicture(String name, Dictionary owner){
		this.name = name;
	...
	public Element getElement() {
		Element e = DocumentHelper.createElement("picture");
		...
		e.addElement("pictureUrl").setText(getPictureUrl());
	...
	public IComponentDefinition copy() {
		ComponentPicture copy = new ComponentPicture("Copy_of_" + name, dictionary);
