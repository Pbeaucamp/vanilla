...
public class LabelComponent implements IComponentDefinition {
	private String name;
	...
	private LabelRenderer renderer = LabelRenderer.PARAGRAPH;
	...
	public LabelComponent(String name, Dictionary owner){
		this.name = name;
		this.dictionary = owner;
		LabelOptions opts = new LabelOptions();
		options.add(opts);
		opts.setText("Label");
	...
	public void setText(String text){
		LabelOptions opt = (LabelOptions)getOptions(LabelOptions.class);
	...
	public Element getElement() {
		Element e = DocumentHelper.createElement("label");
	...
	public void setRenderer(LabelRenderer renderer) {
		this.renderer = renderer;
	}

	@Override
	public IComponentDefinition copy() {
		LabelComponent copy = new LabelComponent("Copy_of_" + name, dictionary);
