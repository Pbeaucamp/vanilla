...
public class ComponentTimer implements IComponentDefinition{
	private String name;
	...
	public ComponentTimer(String name, Dictionary owner){
		this.name = name;
	...
	public Element getElement() {
		Element e = DocumentHelper.createElement("componentTimer");
	...
	public IComponentDefinition copy() {
		ComponentTimer copy = new ComponentTimer("Copy_of_" + name, dictionary);
