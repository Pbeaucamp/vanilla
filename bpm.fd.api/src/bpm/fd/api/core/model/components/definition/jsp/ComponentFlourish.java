...
public class ComponentFlourish implements IComponentDefinition {
	...
	public ComponentFlourish(String name, Dictionary dictionary) {
		this.dictionary = dictionary;
		this.name = name;
		options.add(new FlourishOptions());
	...
	public IComponentOptions getOptions(Class<?> classOption) {
		for (IComponentOptions c : options) {
			if (c.getClass() == classOption) {
				return c;
			}
		}
		return null;
	...
	public Element getElement() {
		Element e = DocumentHelper.createElement("flourish");
		...
		if (getUrl() != null) {
			e.addElement("flourishId").setText(getUrl() + "");
		}
	...
	public IComponentDefinition copy() {
		ComponentFlourish copy = new ComponentFlourish("Copy_of_" + name, dictionary);
