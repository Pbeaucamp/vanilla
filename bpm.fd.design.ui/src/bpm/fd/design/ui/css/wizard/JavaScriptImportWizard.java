...
public class JavaScriptImportWizard extends Wizard implements IImportWizard {
	
	CssImportWizardPage mainPage;

	public JavaScriptImportWizard() throws Exception{
		super();
		if (Activator.getDefault().getProject() == null){
			throw new Exception(Messages.JavaScriptImportWizard_0);
		}
	}
	...
	public boolean performFinish() {
		try{
			...
			FileJavaScript cssF = new FileJavaScript(file.getName(), file.getLocation().toFile());
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		setWindowTitle(Messages.JavaScriptImportWizard_2); //NON-NLS-1
    ...
    public void addPages() {
    	mainPage = new CssImportWizardPage(Messages.JavaScriptImportWizard_3, FileJavaScript.extensions); //NON-NLS-1
