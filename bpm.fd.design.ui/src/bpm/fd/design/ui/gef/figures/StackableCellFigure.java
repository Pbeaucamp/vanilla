...
public class StackableCellFigure extends AbstractBaseFigure {

	static{
		ColorManager.getColorRegistry().put(ColorManager.COLOR_STACKABLECELL_BORDER, new RGB(255, 0, 0));
	}

	private ImageFigure pict, events;
	public StackableCellFigure(boolean isEmpty){
		super(ColorManager.COLOR_STACKABLECELL_BORDER);
	...
	public void unhighlightBorder() {
		...
		getOuterBorder().setColor(ColorManager.getColorRegistry().get(ColorManager.COLOR_STACKABLECELL_BORDER));
	}
