...
public class CustomTabLayoutPanel extends ResizeComposite implements HasWidgets,
   ...
   */
  public CustomTabLayoutPanel(double barHeight, Unit barUnit, boolean tabAtBottom) {
    ...
    if(tabAtBottom){
    	panel.setWidgetTopBottom(deckPanel, 0, Unit.PX, barHeight, barUnit);
    }
    else {
