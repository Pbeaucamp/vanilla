...
//		currentPath = currentPath.replace("//", "/");
		...
		try {
			...
			while ((buf = br.readLine()) != null){
				...
				else if (buf.startsWith("bpm.vanilla.norparena.shapeFileLocation=")){
					content.append("bpm.vanilla.norparena.shapeFileLocation=");
					content.append(currentPath);
					content.append("/webapps/vanilla_files/shape_files");
					
					System.out.println("set bpm.vanilla.norparena.shapeFileLocation=" + currentPath + "/webapps/vanilla_files/shape_files");
				}
				else{
					content.append(buf);
