...
{
    static String ODA_DATA_SOURCE_ID = "bpm.excel.oda.runtime";  //$NON-NLS-1$
    
    public static final String LOCAL_FILE_DATASET_TYPE = "bpm.excel.oda.runtime.localFile";
    public static final String VANILLA_DATASET_TYPE = "bpm.excel.oda.runtime";
	...
	{
        if (LOCAL_FILE_DATASET_TYPE.equals(dataSourceType)){
