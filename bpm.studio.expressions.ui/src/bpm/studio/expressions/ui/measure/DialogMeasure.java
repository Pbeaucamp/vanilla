...
import bpm.studio.expressions.core.model.FmdtMeasure;
...
//				getButton(IDialogConstants.OK_ID).setEnabled(!"".equals(name.getText()));
//				
//			}
//		});
//		
...
//		getShell().setText("Define Measure");
//		if (measure != null){
